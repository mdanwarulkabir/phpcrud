<?php
    ...
    require_once("includes/validate.php");
      ...
      // Handling empty fields
		...
		$stts=0;
		$stts=$appdb->insertGarment($gender, $clothes_type, $size, $color, $features_str, $price, $description,$add_by,$sdate,$filename,$destination);
		if($stts==1){
		echo '<section class="success-row">';
			echo '<div>';
			echo '<h3 style="text-align:center">Garment entry successfully!</h3>';
			echo '<h6 style="text-align:center"><a href="view.php">View Garment List</a></h6>';
			echo '</div>';
			echo '</section>';
			
		}else{
		echo '<p>Garment erntry failed, try again!</p>';
		}
		}
	echo '</main>';
	//Including footer
